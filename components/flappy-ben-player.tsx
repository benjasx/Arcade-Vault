...
import { createFlappyBenGame, type FlappyBenHandle } from "@/lib/games/flappy-ben";
 ...
 * la plataforma. El HUD (solo score) se dibuja en el canvas con los dígitos
 * sprite del atlas; aquí solo viven el marco, los botones PAUSA/SALIR y el
 * modal de fin de partida.
 */
export function FlappyBenPlayer({ game }: { game: Game }) {
  ...
  useEffect(() => {
    const h = createFlappyBenGame(canvasRef.current!, {
      onGameOver: (score) => {
        setFinalScore(score);
        setOver(true);
